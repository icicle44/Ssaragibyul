			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">펀딩 신고 리스트</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="adminFundingAccusationList.do">펀딩 신고 관리</a>
							</li>
						</ul>
					</div>
					<div class="row">
...
<%-- 															<c:if test="${message.msgType != 0}">
															...
															<td><input type="checkbox" class="msg-del-check" name="chk" value="${fList.accuFundingNo }"></td>					
														</tr>
													</c:forEach>
											</tbody>
										</table>
										 ...
										 <table style="margin: auto; text-align: center;">
												...
												<tr class="text-center">
													<td colspan="6" style="border-top:hidden;">
														<!-- 이전 -->
														<c:url var="before" value="adminFundingAccusationList.do">
														...
														<c:forEach var="p" begin="${pi.startPage}" end="${pi.endPage }">
															<c:url var="pagination" value="adminFundingAccusationList.do">
														...
														<!-- 다음 -->
														<c:url var="after" value="adminFundingAccusationList.do">
															<c:param name="page" value="${pi.currentPage + 1}"></c:param>
														</c:url>
														<c:if test="${pi.listCount ne 0 }">
