...
<link rel="stylesheet" type="text/css"
	href="/resources/css/member/memberJoin.css">
	...
	<form action="memberRegister.do" method="post"
		...
		<div class="contents">
			<table width="650" cellspacing="5">
				<tr>
					<td>* 아이디 <span class="guide ok">사용 가능한 아이디입니다.</span> <span
						class="guide error">이미 사용중인 아이디입니다.</span>
					</td>
				</tr>
				<tr>
					<td><input type="text" name="userId" id="userId"
						placeholder="영문소문자,숫자 4자 이상" size="30" required></td>
				</tr>
				<tr>
					<td>* 비밀번호</td>
				</tr>
				...
				<tr>
					<td><input type="text" name="address1"
						class="postcodify_address" id="addr"></td>
				</tr>
				<tr>
