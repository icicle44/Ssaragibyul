	...
	<main class="main-content">
		...
		<br><br><br><br><br><br>
			<section id="sectionSuggest1">
				...
				<div>
					<input type="text" name="subjectName"  id="title1" maxlength="50" placeholder="50자 이내로 작성해주세요." >
				...
				<div>
					<input type="file" name="uploadFileMain" id="input-file1" style="display:none">
			...
			<section id="sectionSuggest3">
				...
				<div>
					<input type="text" name="productName"  id="title2" maxlength="50" placeholder="50자 이내로 작성해주세요." >
					<span id="counter2">( 0 / 50 )</span>
				</div><br>
				<span id="project-title">리워드 금액</span><br>
				<span>최소 1,000원 이상이어야 합니다.</span><br>
				<div>
					<input type="text" name="optionPrice" id="goal"> 원
				</div><br>
			    <span id="project-title">리워드 제공 가능 수</span><br>
				<span>최소 2개 이상이어야 합니다.</span><br>
				<div>
					<input type="text" name="optionLimit" id="goal"> 개
				</div><br>
				<span id="project-title">리워드 내용</span><br>
				<span>리워드 제품에 대한 설명을 상세히 적어주세요. </span><br>
				<br>
				<div>
					<textarea name="productContent" rows="5" wrap="virtual" id="waring" maxlength="1500" style="resize: none;" placeholder="펀딩 성공시 보낼 리워드 제품에대해 적어주세요."></textarea>
