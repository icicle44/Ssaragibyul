	...
	<header class="header-bar d-flex align-items-center site-navbar-target"
		...
		<div class="main-menu">
			<ul class="js-clone-nav">
				<li><a href="#section-home" class="nav-link">홈</a></li>
				<li><a href="#section-funding" class="nav-link">기본 정보</a></li>
				<li><a href="#section-donation" class="nav-link">스토리</a></li>
				<li><a href="#section-bio" class="nav-link">금액 설정</a></li>
				<li><a href="#section-blog" class="nav-link">안내사항</a></li>
