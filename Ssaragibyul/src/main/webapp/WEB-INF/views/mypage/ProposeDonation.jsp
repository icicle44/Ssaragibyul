...
<body>
    ...
    <div class="background">
        <div class="contents">
            ...
            <div class="rightCon">
                <h2 align="center" id="h2">제안한 기부 프로젝트</h2>
                <div class="f-top">
                    <div class="count">
                  ...
                  <div class="category">
                        <select id="divide" name="divide" onchange="location.href=this.value">
                            ...
                            <option value="proposeDonation.do"   id="op">추가순</option>
                            <option value="proposeDonationLike.do" id="op">좋아요순</option>
                            <option value="proposeDonationMoney.do" id="op">모금액순</option>
                        </select></div>
                </div>
            
                <c:forEach var="p" items="${propDonationList}" varStatus="status"> 
                <div class="cont">
                    <div class="img">
                    	<img src="/resources/dUpLoadFiles/${p.donationFile.fileName}"id="f-img">
                    </div>
                    <div>
                    ...
                    <div class="title">
                        ...
                        <div class="btn">
                        <c:if test="${p.leftDate >= 1}">
                        	<form action="donationgModifyView.do" method="post" name="fundingGo" id="postForm">
          ...
          <div class="table-users">
			<table cellspacing="0">  
				...
				<tr align="center" height="20">
					<td colspan="8">
					<!-- 이전 -->
					<c:url var="before" value="proposeDonation.do">
				...
				<c:forEach var="p" begin="${pi.startPage }" end="${pi.endPage }">
					<c:url var="pagination" value="proposeDonation.do">
				...
				<!-- 다음 -->
				<c:url var="after" value="proposeDonation.do">
					<c:param name="page" value="${pi.currentPage + 1 }"></c:param>
				</c:url>
