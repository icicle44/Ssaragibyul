...
public class DonationController {
	...
	public ModelAndView dDetail(ModelAndView mv,
								@RequestParam("dProjectNo")int dProjectNo,
	...
	// 기부 등록
	public ModelAndView dRegister(ModelAndView mv,
	...
	// 기부 게시글 수정
	public ModelAndView dModifyView(ModelAndView mv,
								@RequestParam("dProjectNo") int dProjectNo) {
		Donation donation = dService.printOne(dProjectNo);
		return mv;
	}
	...
	// 파일 수정
	public ModelAndView dUpdate(ModelAndView mv,
								@ModelAttribute Donation donation) {
		// 삭제 후 업로드
		// 기존 파일 삭제
		// 새 파일 업로드
	...
	public String likeView() {
		...
		// 제안한 기부 프로젝트
			public String lDelete(Model model, @RequestParam("dProjectNo") int dProjectNo
								,@ModelAttribute DonationLike dLike) {
				// 업로드 된 파일 삭제
				// 디비에 데이터 업데이트
	...
	// 제안한 기부 프로젝트 수정
		public ModelAndView sModifyView(ModelAndView mv,
									@RequestParam("dProjectNo") int dProjectNo) {
		...
		// 파일 수정
		public ModelAndView sUpdate(ModelAndView mv,
									@ModelAttribute Donation donation) {
			// 삭제 후 업로드
			// 기존 파일 삭제
			// 새 파일 업로드
